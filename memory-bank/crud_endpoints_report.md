# CRUD Routes & Controllers Audit Report
...
- **Controller**: LeaveRequestController
- **Missing Method**: apiDestroy
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveRequestController.php
- **Route Type**: api

- **Controller**: LeaveApprovalController
- **Missing Method**: apiApprove
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveApprovalController.php
- **Route Type**: api

- **Controller**: LeaveApprovalController
- **Missing Method**: apiReject
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveApprovalController.php
- **Route Type**: api

- **Controller**: LeaveBalanceController
- **Missing Method**: apiIndex
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveBalanceController.php
- **Route Type**: api
...
- **Missing Method**: apiIndex
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveTypeController.php
- **Route Type**: api

- **Controller**: LeaveController
- **Missing Method**: apiCalendar
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveController.php
- **Route Type**: api

- **Controller**: LeaveController
- **Missing Method**: apiCalendarMonth
- **File**: D:\Apps\snd-app/Modules/LeaveManagement/Http/Controllers/LeaveController.php
- **Route Type**: api
...
- **Missing Method**: create
- **File**: D:\Apps\snd-app/Modules/Localization/Http/Controllers/LocalizationController.php
- **Route Type**: web
...
- **Controller**: LocalizationController
- **Missing Method**: scanTranslations
- **File**: D:\Apps\snd-app/Modules/Localization/Http/Controllers/LocalizationController.php
- **Route Type**: web
...
- **Controller**: LocalizationController
- **Missing Method**: destroyLocale
- **File**: D:\Apps\snd-app/Modules/Localization/Http/Controllers/LocalizationController.php
- **Route Type**: web

- **Controller**: LocalizationController
- **Missing Method**: destroyLanguage
- **File**: D:\Apps\snd-app/Modules/Localization/Http/Controllers/LocalizationController.php
- **Route Type**: web
...
- **Missing Method**: syncSubscription
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/PushNotificationController.php
- **Route Type**: api

- **Controller**: PushNotificationController
- **Missing Method**: getUserSubscriptions
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/PushNotificationController.php
- **Route Type**: api

- **Controller**: PushNotificationController
- **Missing Method**: trackInteraction
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/PushNotificationController.php
- **Route Type**: api

- **Controller**: PushNotificationController
- **Missing Method**: sendTestNotification
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/PushNotificationController.php
- **Route Type**: api

- **Controller**: PWAController
- **Missing Method**: getStats
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/PWAController.php
- **Route Type**: api

- **Controller**: PWAController
- **Missing Method**: checkForUpdates
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/PWAController.php
- **Route Type**: api
...
- **Controller**: MobileAuthApiController
- **Missing Method**: getUserStats
- **File**: D:\Apps\snd-app/Modules/MobileBridge/Http/Controllers/Api/MobileAuthApiController.php
- **Route Type**: api

### Notifications

- **Controller**: NotificationController
- **Missing Method**: unread
- **File**: D:\Apps\snd-app/Modules/Notifications/Http/Controllers/NotificationController.php
- **Route Type**: api
...
- **Controller**: NotificationController
- **Missing Method**: markAsRead
- **File**: D:\Apps\snd-app/Modules/Notifications/Http/Controllers/NotificationController.php
- **Route Type**: api

- **Controller**: NotificationController
- **Missing Method**: bulkAction
- **File**: D:\Apps\snd-app/Modules/Notifications/Http/Controllers/NotificationController.php
- **Route Type**: api

- **Controller**: NotificationController
- **Missing Method**: destroyAll
- **File**: D:\Apps\snd-app/Modules/Notifications/Http/Controllers/NotificationController.php
- **Route Type**: api
...
- **Controller**: RentalController
- **Missing Method**: print
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: start
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: complete
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: markPaymentPending
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: markClosed
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: checkOverdue
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: approveExtension
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web

- **Controller**: RentalWorkflowController
- **Missing Method**: rejectExtension
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalWorkflowController.php
- **Route Type**: web
...
- **Controller**: RentalExtensionController
- **Missing Method**: extend
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalExtensionController.php
- **Route Type**: api

- **Controller**: RentalController
- **Missing Method**: return
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalController.php
- **Route Type**: api
...
- **Missing Method**: show
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalHistoryController.php
- **Route Type**: api

- **Controller**: QuotationController
- **Missing Method**: convertToRental
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/QuotationController.php
- **Route Type**: api

- **Controller**: RentalAnalyticsController
- **Missing Method**: rentalsAnalytics
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalAnalyticsController.php
- **Route Type**: api

- **Controller**: RentalAnalyticsController
- **Missing Method**: revenueAnalytics
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalAnalyticsController.php
- **Route Type**: api

- **Controller**: RentalAnalyticsController
- **Missing Method**: equipmentUtilization
- **File**: D:\Apps\snd-app/Modules/RentalManagement/Http/Controllers/RentalAnalyticsController.php
- **Route Type**: api
...
- **Missing Method**: bulkUpdate
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingController.php
- **Route Type**: web

- **Controller**: CompanySettingsController
- **Missing Method**: updateLogo
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/CompanySettingsController.php
- **Route Type**: web

- **Controller**: CompanySettingsController
- **Missing Method**: updateAddress
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/CompanySettingsController.php
- **Route Type**: web

- **Controller**: CompanySettingsController
- **Missing Method**: updateContact
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/CompanySettingsController.php
- **Route Type**: web

- **Controller**: PasswordController
- **Missing Method**: index
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/PasswordController.php
- **Route Type**: web

- **Controller**: SettingController
- **Missing Method**: adminDashboard
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingController.php
- **Route Type**: web

- **Controller**: SettingController
- **Missing Method**: systemSettings
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingController.php
- **Route Type**: web

- **Controller**: SettingController
- **Missing Method**: updateSystemSettings
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingController.php
- **Route Type**: web

- **Controller**: SettingController
- **Missing Method**: backupSettings
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingController.php
- **Route Type**: web

- **Controller**: SettingController
- **Missing Method**: updateBackupSettings
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingController.php
- **Route Type**: web

- **Controller**: SettingApiController
- **Missing Method**: bulkUpdate
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/SettingApiController.php
- **Route Type**: api

- **Controller**: CompanySettingsApiController
- **Missing Method**: index
- **File**: D:\Apps\snd-app/Modules/Settings/Http/Controllers/Api/CompanySettingsApiController.php
- **Route Type**: api
...
- **Missing Method**: monthlyReport
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetReportController.php
- **Route Type**: web

- **Controller**: TimesheetReportController
- **Missing Method**: generatePaySlip
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetReportController.php
- **Route Type**: web

- **Controller**: TimesheetController
- **Missing Method**: generatePaySlip
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: web

- **Controller**: TimesheetController
- **Missing Method**: generateHtmlPaySlip
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: web

- **Controller**: TimesheetController
- **Missing Method**: bulkUpload
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: api

- **Controller**: TimesheetController
- **Missing Method**: approvalHistory
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: api
...
- **Controller**: TimesheetController
- **Missing Method**: projectSummary
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: api

- **Controller**: TimesheetController
- **Missing Method**: dailyReport
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: api

- **Controller**: TimesheetController
- **Missing Method**: weeklyReport
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: api

- **Controller**: TimesheetController
- **Missing Method**: exportPdf
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimesheetController.php
- **Route Type**: api
...
- **Missing Method**: clockIn
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: clockOut
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: getActiveEntry
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: getCurrentWeekEntries
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: startBreak
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: endBreak
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: locationCheck
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: TimeEntryController
- **Missing Method**: offlineSync
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/TimeEntryController.php
- **Route Type**: api

- **Controller**: GeofenceController
- **Missing Method**: getNearbyZones
- **File**: D:\Apps\snd-app/Modules/TimesheetManagement/Http/Controllers/GeofenceController.php
- **Route Type**: api
