...
// Assets to precache
const PRECACHE_ASSETS = ['/', '/offline', '/favicon.ico', '/logo.svg', '/manifest.json'];
...
function isViteRequest(request) {
    ...
    if (url.hostname === 'localhost' || self.location.hostname === 'new_snd_app.test' || self.location.hostname === 'localhost') {
