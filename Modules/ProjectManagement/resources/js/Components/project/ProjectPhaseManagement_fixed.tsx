                                ...
                                <div>
                                    ...
                                    <div className="flex items-center space-x-1">
                                        ...
                                        <span>
                                            ...
                                            {project.actual_end_date ? formatDate(project.actual_end_date) : formatDate(project.expected_end_date)}
                                        </span>
                                    </div>
                                </div>
                                <div>
                                ...
                                <Card key={phase.id} className={phase.status === 'in_progress' ? 'border-primary' : ''}>
                                    ...
                                    <CardContent>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <Button variant="outline" size="sm" onClick={() => handleDeletePhase(phase)}>
