...
const TaskDialog = memo(function TaskDialog({ open, onOpenChange, projectId, initialData = null, assignableUsers = [], onSuccess }: TaskDialogProps) {
    ...
    return (
        <Portal>
            {/* Backdrop */}
            <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black" onClick={handleClose}>
                {/* Dialog */}
                <div
