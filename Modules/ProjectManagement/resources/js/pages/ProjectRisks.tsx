        ...
        <Card>
            ...
            <CardContent>
                ...
                <div className="space-y-2">
                    {risks.map((risk) => (
                        <Card key={risk.id} className="flex flex-col p-3 md:flex-row md:items-center md:justify-between">
                            <div>
                                ...
                                {risk.mitigation_plan && <div className="mt-1 text-xs text-blue-700">Mitigation: {risk.mitigation_plan}</div>}
                            </div>
                            <div className="mt-2 flex gap-2 md:mt-0">
                                <Button size="sm" variant="outline" onClick={() => handleEdit(risk)}>
                                    Edit
                                </Button>
                                <Button size="sm" variant="destructive" onClick={() => handleDelete(risk.id)}>
                                    Delete
                                </Button>
                            </div>
                        </Card>
