...
import { AppLayout, Card, CardContent, CardHeader, CardTitle, Tabs, TabsContent, TabsList, TabsTrigger } from '@/Core';
import React, { Suspense, lazy, useCallback, useMemo } from 'react';
import { useTranslation } from 'react-i18next';
import { useResourceStore } from '../../stores/resourceStore';
import type { EquipmentResource, ExpenseResource, FuelResource, ManpowerResource, MaterialResource } from '../../types/projectResources';
...
export function ResourcesPage({ project, manpowers, equipments, materials, fuel, expenses, availableEquipment }: ResourcesPageProps) {
        ...
        () => (
            <Suspense fallback={<div>Loading...</div>}>
                <TabsContent value="manpower">
                    <MemoizedManpowerTab project={project} manpowers={manpowers} />
                </TabsContent>

                <TabsContent value="equipment">
                    <MemoizedEquipmentTab project={project} equipments={equipments} availableEquipment={availableEquipment} />
                </TabsContent>

                <TabsContent value="material">
                    <MemoizedMaterialTab project={project} projectMaterials={materials} />
                </TabsContent>

                <TabsContent value="fuel">
                    <MemoizedFuelTab project={projectWithStringId} fuel={fuel} projectEquipment={availableEquipment} />
                </TabsContent>

                <TabsContent value="expense">
                    <MemoizedExpenseTab project={project} expenses={expenses} />
                </TabsContent>
            </Suspense>
        ),
