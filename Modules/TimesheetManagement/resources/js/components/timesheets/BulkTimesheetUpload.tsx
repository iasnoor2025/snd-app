import { Alert, AlertDescription, AlertTitle, Button, Card, CardContent, Input, Label, Progress } from '@/Core';
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">Upload a CSV file containing timesheet data</p>
                                </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.file && <p className="text-sm text-red-500">{String(errors.file.message)}</p>}
                                </div>
                                ...
                                <Button type="submit" disabled={isUploading} className="flex w-full items-center justify-center gap-1">
                                    {isUploading ? (
                                        <>
                    ...
                    <CardContent className="pt-6">
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Ensure your CSV file follows this format</p>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div className="rounded-md bg-green-50 p-4">
                                    ...
                                    <p className="text-2xl font-bold text-green-700">{uploadSummary.successful}</p>
                                </div>
                                <div className="rounded-md bg-red-50 p-4">
                                    <p className="text-sm text-red-600">Failed</p>
                                    <p className="text-2xl font-bold text-red-700">{uploadSummary.failed}</p>
                                </div>
                            </div>
