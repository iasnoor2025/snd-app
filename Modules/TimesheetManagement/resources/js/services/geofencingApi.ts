...
export const geofenceZoneApi = {
    ...
    getAll: async (filters?: GeofenceFilterOptions): Promise<GeofenceZone[]> => {
        ...
        const response: AxiosResponse<ApiResponse<GeofenceZone[]>> = await axios.get(`${API_BASE}?${params.toString()}`);
        return response.data.data;
    },

    // Get single geofence zone
    getById: async (id: number): Promise<GeofenceZone> => {
        const response: AxiosResponse<ApiResponse<GeofenceZone>> = await axios.get(`${API_BASE}/${id}`);
        return response.data.data;
    },

    // Create new geofence zone
    create: async (data: GeofenceFormData): Promise<GeofenceZone> => {
        const response: AxiosResponse<ApiResponse<GeofenceZone>> = await axios.post(API_BASE, data);
        return response.data.data;
    },

    // Update geofence zone
    update: async (id: number, data: Partial<GeofenceFormData>): Promise<GeofenceZone> => {
        const response: AxiosResponse<ApiResponse<GeofenceZone>> = await axios.put(`${API_BASE}/${id}`, data);
        return response.data.data;
    },
    ...
    toggleActive: async (id: number): Promise<GeofenceZone> => {
        const response: AxiosResponse<ApiResponse<GeofenceZone>> = await axios.post(`${API_BASE}/${id}/toggle-active`);
        return response.data.data;
    },
    ...
    getNearby: async (latitude: number, longitude: number, radius?: number): Promise<GeofenceZone[]> => {
        ...
        const response: AxiosResponse<ApiResponse<GeofenceZone[]>> = await axios.get(`${MOBILE_API_BASE}/geofences/nearby?${params.toString()}`);
        return response.data.data;
    },
};
...
export const geofenceValidationApi = {
    ...
    validateLocation: async (latitude: number, longitude: number, employeeId?: number, projectId?: number): Promise<GeofenceValidationResult> => {
        const response: AxiosResponse<ApiResponse<GeofenceValidationResult>> = await axios.post(`${API_BASE}/validate-location`, {
            latitude,
            longitude,
    ...
    validateMobileLocation: async (locationData: LocationData, employeeId: number, projectId?: number): Promise<GeofenceValidationResult> => {
        const response: AxiosResponse<ApiResponse<GeofenceValidationResult>> = await axios.post(`${MOBILE_API_BASE}/location/validate`, {
            ...locationData,
            employee_id: employeeId,
            project_id: projectId,
        });
...
export const geofenceViolationApi = {
    ...
    getViolations: async (filters?: GeofenceFilterOptions): Promise<GeofenceViolation[]> => {
        ...
        const response: AxiosResponse<ApiResponse<GeofenceViolation[]>> = await axios.get(`${API_BASE}/violations?${params.toString()}`);
        return response.data.data;
    },
    ...
    getViolationStats: async (filters?: GeofenceFilterOptions): Promise<any> => {
        ...
        const response: AxiosResponse<ApiResponse<any>> = await axios.get(`${API_BASE}/violation-stats?${params.toString()}`);
        return response.data.data;
    },
    ...
    exportViolations: async (options: GeofenceExportOptions): Promise<Blob> => {
        ...
        const response: AxiosResponse<Blob> = await axios.get(`${API_BASE}/violations/export?${params.toString()}`, { responseType: 'blob' });
...
export const geofenceStatsApi = {
    ...
    getStatistics: async (filters?: GeofenceFilterOptions): Promise<GeofenceStats> => {
        ...
        const response: AxiosResponse<ApiResponse<GeofenceStats>> = await axios.get(`${API_BASE}/statistics?${params.toString()}`);
        return response.data.data;
    },
    ...
    exportStatistics: async (options: GeofenceExportOptions): Promise<Blob> => {
        ...
        const response: AxiosResponse<Blob> = await axios.get(`${API_BASE}/statistics/export?${params.toString()}`, { responseType: 'blob' });
        return response.data;
    },
    ...
    exportWorkAreaCoverage: async (options: GeofenceExportOptions): Promise<Blob> => {
        ...
        const response: AxiosResponse<Blob> = await axios.get(`${API_BASE}/work-area-coverage/export?${params.toString()}`, { responseType: 'blob' });
        return response.data;
    },
};
