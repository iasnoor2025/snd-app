    ...
    <div className="space-y-8">
      <Card>
        ...
        <CardContent>
          ...
          <div className="text-xs text-muted-foreground mt-2">Last updated: {stats.lastUpdated}</div>
        </CardContent>
      </Card>
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <ul className="divide-y">
            {recentEntries.map((entry) => (
              <li key={entry.id} className="py-2 flex items-center gap-4">
            ...
            {recentEntries.length === 0 && (
              <li className="py-4 text-center text-muted-foreground">No recent entries</li>
            )}
          </ul>
        </CardContent>
      </Card>
