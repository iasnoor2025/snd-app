import { AppLayout, Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Input, Label, Textarea } from '@/Core';
...
export default function Edit({
    ...
    return (
        <AppLayout title={`Edit Customer: ${customer.name}`} breadcrumbs={breadcrumbs} requiredPermission="customers.edit">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.tax_number && <p className="mt-1 text-sm text-red-500">{errors.tax_number}</p>}
                                </div>
                                <div>
