            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Leave balance details for {currentYear}</p>
                        </div>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Detailed breakdown by leave type for {currentYear}</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-6">
                            {balanceDetails.map((detail) => (
                                <div key={detail.type} className="space-y-3">
                                    ...
                                    {detail.requests.length > 0 && (
                                        <div className="mt-4">
                                            <h4 className="mb-2 text-sm font-medium">{t('recent_requests')}</h4>
                                            <div className="space-y-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Complete history of approved leave requests for this year</CardDescription>
                    </CardHeader>
                    <CardContent>
