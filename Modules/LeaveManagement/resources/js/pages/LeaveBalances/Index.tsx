...
const LeaveBalancesIndex: React.FC = () => {
    ...
    const overallUsagePercentage = totalStats.totalAllocated > 0 ? (totalStats.totalUsed / totalStats.totalAllocated) * 100 : 0;
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Monitor employee leave allocations and usage</p>
                    </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Days used so far</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Overall leave utilization</p>
                        </CardContent>
                    </Card>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Current year leave allocation and usage for all employees</CardDescription>
                    </CardHeader>
                    <CardContent>
                                        ...
                                        <TableRow key={balance.employee.id}>
                                            <TableCell className="font-medium">
                                                <div>
                                                    ...
                                                    <div className="text-sm text-muted-foreground">ID: {balance.employee.id}</div>
                                                </div>
                                            </TableCell>
                                            {leaveTypes.map((type) => {
