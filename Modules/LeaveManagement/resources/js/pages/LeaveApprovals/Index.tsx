...
const LeaveApprovalsIndex: React.FC = () => {
    ...
    const handleBulkApprove = () => {
        ...
        router.post(
            route('leaves.approvals.bulk-approve'),
            {
    ...
    const leaveTypes = ['annual', 'sick', 'personal', 'maternity', 'hajj', 'umrah', 'unpaid', 'other'];
            ...
            <div className="space-y-6">
                            ...
                            <Dialog open={showBulkApprovalDialog} onOpenChange={setShowBulkApprovalDialog}>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            You are about to approve {selectedRequests.length} leave request(s). This action cannot be undone.
                                        </DialogDescription>
                                    </DialogHeader>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{new Set(pendingRequests.data.map((r) => r.employee_id)).size}</div>
                            <p className="text-xs text-muted-foreground">With pending requests</p>
                        </CardContent>
                    </Card>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div>
                                <label className="mb-2 block text-sm font-medium">{t('lbl_leave_type')}</label>
                                <Select
                            ...
                            <div>
                                <label className="mb-2 block text-sm font-medium">{t('lbl_from_date')}</label>
                                <Input
                                    type="date"
                            ...
                            <div>
                                <label className="mb-2 block text-sm font-medium">{t('lbl_to_date')}</label>
                                <Input
                                    type="date"
                                        ...
                                        <TableRow key={request.id}>
                                            ...
                                            <TableCell className="font-medium">
                                                <div>
                                                    ...
                                                    <div className="text-sm text-muted-foreground">{request.employee?.email}</div>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <Badge variant="outline">{calculateDays(request.start_date, request.end_date)} days</Badge>
                                            </TableCell>
