...
const LeaveApprovalShow: React.FC = () => {
    ...
    const handleApprove = () => {
        ...
        router.post(
            route('leaves.approvals.approve', leaveRequest.id),
            {
    ...
    const handleReject = () => {
        setIsProcessing(true);
        router.post(
            route('leaves.approvals.reject', leaveRequest.id),
            {
        ...
        <AppLayout>
            ...
            <div className="space-y-6">
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbLink href={route('leaves.approvals.index')}>{t('leave_approvals')}</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">Leave Request #{leaveRequest.id}</h1>
                            ...
                            <Dialog open={showRejectionDialog} onOpenChange={setShowRejectionDialog}>
                                ...
                                <DialogContent>
                                    ...
                                    <DialogFooter>
                                        ...
                                        <Button variant="destructive" onClick={handleReject} disabled={!rejectionNotes.trim() || isProcessing}>
                            ...
                            <CardContent className="space-y-6">
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1">
                                            <Badge variant="outline">{calculateDays(leaveRequest.start_date, leaveRequest.end_date)} days</Badge>
                                        </div>
                                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <a href={`mailto:${leaveRequest.employee?.email}`} className="text-blue-600 hover:text-blue-800">
                                ...
                                {leaveRequest.employee?.phone && (
                                    <div>
                                        ...
                                        <div className="mt-1">
                                            <a href={`tel:${leaveRequest.employee.phone}`} className="text-blue-600 hover:text-blue-800">
                                                {leaveRequest.employee.phone}
                                            </a>
                                        </div>
                                    </div>
                        ...
                        {isPending && (
                            <Card>
                                ...
                                <CardContent className="space-y-3">
                                    <Button className="w-full" onClick={() => setShowApprovalDialog(true)} disabled={isProcessing}>
                                        <CheckIcon className="mr-2 h-4 w-4" />
                                        Approve Request
                                    </Button>
                                    <Button
                            ...
                            <Card className="border-yellow-200 bg-yellow-50">
                                <CardContent className="pt-6">
                                    <div className="flex items-start space-x-3">
                                        <AlertCircleIcon className="mt-0.5 h-5 w-5 text-yellow-600" />
                                        <div>
