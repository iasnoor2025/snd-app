    ...
    <AppLayout title="Payroll Report">
      <div className="container mx-auto py-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
          <Card>
            <CardHeader><CardTitle>Total Payrolls</CardTitle></CardHeader>
            <CardContent><div className="text-2xl font-bold">{mockSummary.total_payrolls}</div></CardContent>
          </Card>
          <Card>
            <CardHeader><CardTitle>Paid</CardTitle></CardHeader>
            <CardContent><div className="text-2xl font-bold text-green-600">{mockSummary.paid}</div></CardContent>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <CardContent><div className="text-2xl font-bold text-red-600">{mockSummary.failed}</div></CardContent>
          </Card>
        </div>
        <Card className="mb-6">
          <CardHeader>
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row gap-4 mb-4">
              ...
              <div className="w-full md:w-48">
                <Input placeholder="Period (YYYY-MM)" value={data.period} onChange={e => setData(prev => ({ ...prev, period: e.target.value }))} />
              </div>
