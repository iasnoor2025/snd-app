      ...
      <div className="container mx-auto py-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
          <Card>
            ...
            <CardContent><div className="text-2xl font-bold">{mockSummary.total_customers}</div></CardContent>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <CardContent><div className="text-2xl font-bold text-gray-600">{mockSummary.inactive}</div></CardContent>
          </Card>
          <Card>
            <CardHeader><CardTitle>Total Payments</CardTitle></CardHeader>
            <CardContent><div className="text-2xl font-bold">${mockSummary.total_payments}</div></CardContent>
          </Card>
        </div>
        <Card className="mb-6">
          <CardHeader>
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row gap-4 mb-4">
              <div className="flex-1">
                <Input placeholder="Search customer..." value={data.search} onChange={e => setData(prev => ({ ...prev, search: e.target.value }))} />
              </div>
