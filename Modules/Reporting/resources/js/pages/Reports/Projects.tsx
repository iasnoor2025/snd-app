            ...
            <div className="container mx-auto py-6">
                ...
                <div className="mb-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{mockSummary.total_projects}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-gray-600">{mockSummary.completed}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-yellow-600">{mockSummary.on_hold}</div>
                        </CardContent>
                    </Card>
                </div>
                <Card className="mb-6">
