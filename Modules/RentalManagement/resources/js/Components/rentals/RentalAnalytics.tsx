import { Badge, Card, CardContent, CardHeader, CardTitle, formatCurrency, Progress } from '@/Core';
import { Clock, CloudSun, DollarSign, Gauge, Heart, Wrench } from 'lucide-react';
...
export default function RentalAnalytics({
    ...
    const calculateEquipmentHealth = () => {
        ...
        const maintenanceRequired = maintenanceRecords.filter((record) => record.status === 'pending' || record.status === 'in_progress').length;
    ...
    const calculateOperationalMetrics = () => {
        ...
        const endDate = rental.actual_end_date
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
                ...
                <CardContent>
                    <div className="flex items-center justify-between">
                        ...
                        <Badge
                            variant={equipmentHealth.healthScore > 80 ? 'default' : equipmentHealth.healthScore > 60 ? 'secondary' : 'destructive'}
                        >
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-2 text-xs text-muted-foreground">Revenue: {formatCurrency(financialMetrics.totalRevenue)}</div>
                    <div className="text-xs text-muted-foreground">Costs: {formatCurrency(financialMetrics.totalCosts)}</div>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-2 text-xs text-muted-foreground">Equipment Utilization: {equipmentUtilization}%</div>
                </CardContent>
            </Card>
            ...
            {weatherData && (
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-2 text-xs text-muted-foreground">Humidity: {weatherData.humidity}%</div>
                        <div className="text-xs text-muted-foreground">Wind: {weatherData.wind_speed} km/h</div>
                    </CardContent>
                </Card>
            )}
