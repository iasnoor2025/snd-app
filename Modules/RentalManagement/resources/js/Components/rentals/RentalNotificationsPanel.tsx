...
export default function RentalNotificationsPanel({ notifications, className = '' }: RentalNotificationsPanelProps) {
                        ...
                        notifications.map((notification, index) => (
                            <div key={index} className="flex items-start gap-3 rounded-lg bg-muted/50 p-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">{format(new Date(notification.timestamp), 'MMM dd, yyyy HH:mm')}</p>
                                </div>
                            </div>
                        ))
                    )}
