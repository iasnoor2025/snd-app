...
export default function CancelledSection({ rental, rentalItems, permissions }: CancelledSectionProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            <Alert variant="destructive">
                ...
                <AlertDescription>This rental has been cancelled on {getCancellationDate()}.</AlertDescription>
            </Alert>
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>Details about the rental cancellation</CardDescription>
                                </div>
                        ...
                        <CardContent>
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <h3 className="mb-2 font-medium">{t('cancellation_details')}</h3>
                                    ...
                                    <div>
                                        <h3 className="mb-2 font-medium">{t('original_rental_information')}</h3>
                                        <div className="space-y-2">
                                            <div className="grid grid-cols-2 gap-1">
