...
export default function ActiveSection({ rental, rentalItems, invoices, maintenanceRecords, weatherData, metrics, permissions }: ActiveSectionProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            <Alert>
                ...
                <AlertDescription>This rental is currently active. Equipment is in use and the rental period is ongoing.</AlertDescription>
            </Alert>
                        ...
                        <CardContent>
                            {maintenanceRecords && maintenanceRecords.data.length > 0 ? (
                                ...
                                <div className="py-6 text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">Maintenance records will appear here when created.</p>
                                </div>
                            )}
                        </CardContent>
                    </Card>
