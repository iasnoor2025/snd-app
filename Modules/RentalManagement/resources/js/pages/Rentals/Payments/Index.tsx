                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Button asChild variant="outline">
                            <Link href={route('payments.index')}>View All Payments</Link>
                        </Button>
                    </div>
                </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-3">
                                <h3 className="text-sm font-medium text-blue-800">
                                    Payment Management for Rental #{rental.rental_number || rental.id}
                                </h3>
                                <div className="mt-2 text-sm text-blue-700">
                                    <ul className="list-disc space-y-1 pl-5">
                                        <li>
                                            Use <strong>{t('add_payment')}</strong> to record new payments received from customers
                                        </li>
                                        <li>
                                            Total rental amount: <strong>{formatCurrency(rental.total_amount)}</strong>
                                        </li>
                                        <li>
                                            Rental status: <strong>{rental.status}</strong>
                                        </li>
                                        {rental.customer && (
                                            <li>
                                                customer: <strong>{rental.customer.company_name}</strong>
                                            </li>
                                        )}
                                    </ul>
                                </div>
