    ...
    return (
        <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div>
                ...
                />
                {errors.amount && <p className="mt-1 text-sm text-red-600">{t('PayrollManagement:validation.required_amount')}</p>}
            </div>
            ...
            <div>
                ...
                />
                {errors.reason && <p className="mt-1 text-sm text-red-600">{t('PayrollManagement:validation.required_reason')}</p>}
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                />
                {errors.payment_date && <p className="mt-1 text-sm text-red-600">{t('PayrollManagement:validation.required_date')}</p>}
            </div>

            <div className="flex justify-end space-x-3">
                <Link href={route('salary-advances.index')} className={cn(buttonVariants({ variant: 'outline' }))}>
                    {t('ui.buttons.cancel')}
                </Link>
