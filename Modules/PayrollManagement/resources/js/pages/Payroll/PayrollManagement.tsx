        ...
        <div className="container mx-auto space-y-6 py-6">
            <div className="flex items-center justify-between">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground">Generate and manage employee payrolls</p>
                </div>
                <div className="flex items-center gap-2">
                    <Button variant="outline" className="flex items-center gap-1" onClick={() => fetchPayrolls()}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="list">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className="flex items-center gap-2">
                                <Button variant="outline" className="flex items-center gap-1" onClick={() => setSelectedMonth(new Date())}>
                ...
                <TabsContent value="generate">
                    <PayrollGeneration employees={employees} onPayrollCreated={handlePayrollCreated} onCancel={handleBackToList} />
                </TabsContent>
                ...
                <TabsContent value="details">
                    {selectedPayroll && (
                        <PayrollDetails
                            ...
                            onProcessPayment={(paymentMethod, reference) => handleProcessPayment(selectedPayroll.id, paymentMethod, reference)}
                        />
                    )}
                </TabsContent>
            </Tabs>
