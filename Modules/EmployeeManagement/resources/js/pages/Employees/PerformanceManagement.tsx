import { Breadcrumbs, Button, Tabs, TabsContent, TabsList, TabsTrigger } from '@/Core';
        ...
        <div className="container mx-auto space-y-6 py-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="create" className="mt-0">
                    <PerformanceReviewForm employeeId={employeeId ? parseInt(employeeId) : undefined} onSave={handleSave} onCancel={handleCancel} />
                </TabsContent>

                <TabsContent value="edit" className="mt-0">
                    <PerformanceReviewForm review={currentReview} onSave={handleSave} onCancel={handleCancel} />
                </TabsContent>
            </Tabs>
        </div>
    );
