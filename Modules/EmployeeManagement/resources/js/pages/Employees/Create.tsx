import { AppLayout, Button, Card, CardContent, CardHeader, CardTitle, Form, Tabs, TabsContent, TabsList, TabsTrigger } from '@/Core';
...
const formSchema = z.object({
    ...
    contract_hours_per_day: z.coerce
        .number()
        .min(1, 'Contract hours per day must be at least 1')
        .max(24, 'Contract hours cannot exceed 24')
        .optional()
        .default(8),
    contract_days_per_month: z.coerce
        .number()
        .min(1, 'Contract days per month must be at least 1')
        .max(31, 'Contract days cannot exceed 31')
        .optional()
        .default(30),
    ...
    absent_deduction_rate: z.coerce
        .number()
        .min(0, 'Absent deduction rate must be non-negative')
        .max(100, 'Absent deduction rate cannot exceed 100%')
        .optional()
        .default(0),
...
export default function Create({ users, designations, employee, isEditing = false }: Props) {
    ...
    return (
        <AppLayout title={isEditing ? 'Edit Employee' : 'Create Employee'} breadcrumbs={breadcrumbs} requiredPermission="employees.create">
                        ...
                        <Form onSubmit={handleSubmit} className="space-y-8">
                            <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-4">
                                ...
                                <div className="rounded-lg border bg-muted p-4">
                                    <h3 className="mb-4 text-lg font-medium">{t('cost_summary')}</h3>
                                ...
                                <TabsContent value="certifications">
                                    <CertificationsTab form={form} files={files} setFiles={setFiles} onTotalCostChange={setTotalCertificationCost} />
                                </TabsContent>
                            </Tabs>
