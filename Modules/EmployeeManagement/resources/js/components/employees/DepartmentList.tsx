...
import { AlertCircle, Edit, MoreHorizontal, Plus, Search, Trash, Users } from 'lucide-react';
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isEditMode && currentDepartment.id) {
                ...
                setDepartments(departments.map((dept) => (dept.id === currentDepartment.id ? response.data.data : dept)));
            } else {
            ...
            setFormError(error.response?.data?.message || 'An error occurred while saving the department');
        }
    };
                            ...
                            {isLoading ? (
                                ...
                                filteredDepartments.map((department) => (
                                    <TableRow key={department.id}>
                                        ...
                                        <TableCell>
                                            <div className="max-w-xs truncate">{department.description || '-'}</div>
                                        </TableCell>
                                        <TableCell>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {isEditMode ? 'Update department details below' : 'Fill in the details below to create a new department'}
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <form onSubmit={handleFormSubmit}>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="name">
                                    {t('lbl_department_name')} <span className="text-red-500">*</span>
                                </Label>
                                <Input
                                    id="name"
                        ...
                        <DialogFooter className="mt-6">
                            <Button type="submit">{isEditMode ? 'Update Department' : 'Create Department'}</Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
            </Dialog>
