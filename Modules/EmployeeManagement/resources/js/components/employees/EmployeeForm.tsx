                        ...
                        <TabsContent value="basic" className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <div className="space-y-2">
                                    <Label htmlFor="file_number">
                                        {t('file_number')} <span className="text-red-500">*</span>
                                    </Label>
                                    <Input id="file_number" {...register('file_number')} error={errors.file_number?.message} />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="employee_id" {...register('employee_id')} error={errors.employee_id?.message} />
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <div className="space-y-2">
                                    <Label htmlFor="first_name">
                                        {t('lbl_first_name')} <span className="text-red-500">*</span>
                                    </Label>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="last_name">
                                        {t('lbl_last_name')} <span className="text-red-500">*</span>
                                    </Label>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <DatePicker value={watch('date_of_birth')} onChange={(date) => handleDateChange('date_of_birth', date)} />
                                </div>
                        ...
                        <TabsContent value="employment" className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <DatePicker value={watch('hire_date')} onChange={(date) => handleDateChange('hire_date', date)} />
                                </div>
                            </div>
                        ...
                        <TabsContent value="documents" className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <DatePicker value={watch('iqama_expiry')} onChange={(date) => handleDateChange('iqama_expiry', date)} />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <DatePicker value={watch('passport_expiry')} onChange={(date) => handleDateChange('passport_expiry', date)} />
                                </div>
                            </div>
                            ...
                            {employee?.id && (
                                <div className="mt-6 border-t pt-6">
                                    <h3 className="mb-4 text-lg font-medium">{t('document_management')}</h3>
                                    <DocumentManager
                                        modelType="employee"
                                        modelId={employee.id}
                        ...
                        <TabsContent value="salary" className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="overtime_rate_multiplier" type="number" step="0.1" {...register('overtime_rate_multiplier')} />
                                </div>
                            </div>
