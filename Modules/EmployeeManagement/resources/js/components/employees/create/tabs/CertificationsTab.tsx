import { Button, Card, CardContent, CardHeader, CardTitle, Form, FormControl, FormField, FormItem, FormLabel, Input } from '@/Core';
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <FormItem>
                    ...
                    <div className="flex items-center space-x-2">
                        <Input type="file" accept=".pdf,.jpg,.jpeg,.png" onChange={(e) => handleFileChange(prefix, e.target.files?.[0] || null)} />
                        {files[prefix] && (
                            <Button type="button" variant="ghost" size="icon" onClick={() => handleFileChange(prefix, null)}>
                                <X className="h-4 w-4" />
                            </Button>
                        )}
                    </div>
