...
export const AssignmentHistory: React.FC<AssignmentHistoryProps> = ({ employeeId, assignments = [], onViewDetails }) => {
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Track employee's project assignments and roles over time</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <CardContent className="space-y-4">
                    ...
                    <div key={assignment.id} className="space-y-3 rounded-lg border p-4 transition-shadow hover:shadow-md">
                        <div className="flex items-start justify-between">
                            <div className="space-y-1">
                                <h4 className="text-lg font-semibold">{assignment.project_name}</h4>
                ...
                {displayAssignments.length > 5 && (
                    <div className="pt-4 text-center">
                        <Button variant="outline">Load More Assignments</Button>
                    </div>
                )}
            </CardContent>
        </Card>
