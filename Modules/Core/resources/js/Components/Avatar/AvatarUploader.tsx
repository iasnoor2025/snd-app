    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Upload a new avatar image. Supported formats: JPG, PNG, GIF (max 2MB)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        <p className="text-center text-xs text-muted-foreground">Click "Upload New" to select an image from your device</p>
                    </div>
                </div>
