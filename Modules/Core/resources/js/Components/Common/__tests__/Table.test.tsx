...
describe('Table', () => {
    ...
    it('handles sort click', () => {
        ...
        render(<Table data={mockData} columns={columns} onSort={onSort} sortKey="name" sortDirection="asc" />);
    ...
    it('applies row className', () => {
        render(<Table data={mockData} columns={columns} rowClassName="custom-row" />);
    ...
    it('applies dynamic row className', () => {
        render(<Table data={mockData} columns={columns} rowClassName={(item) => `row-${item.id}`} />);
        const rows = screen.getAllByRole('row');
    ...
    it('applies column className', () => {
        ...
        render(<Table data={mockData} columns={columnsWithClassName} />);
    ...
    describe('Pagination', () => {
        ...
        it('shows pagination controls when total items exceed page size', () => {
            render(<Table data={paginatedData} columns={columns} pageSize={10} currentPage={1} totalItems={25} />);
        ...
        it('hides pagination when showPagination is false', () => {
            render(<Table data={paginatedData} columns={columns} pageSize={10} currentPage={1} totalItems={25} showPagination={false} />);
        ...
        it('disables next button on last page', () => {
            render(<Table data={paginatedData} columns={columns} pageSize={10} currentPage={3} totalItems={25} />);
        ...
        it('calls onPageChange when clicking page number', () => {
            ...
            render(<Table data={paginatedData} columns={columns} pageSize={10} currentPage={1} totalItems={25} onPageChange={onPageChange} />);
        ...
        it('calls onPageChange when clicking previous button', () => {
            const onPageChange = jest.fn();
            render(<Table data={paginatedData} columns={columns} pageSize={10} currentPage={2} totalItems={25} onPageChange={onPageChange} />);
            fireEvent.click(screen.getByText('Previous'));
            expect(onPageChange).toHaveBeenCalledWith(1);
        });

        it('shows correct page information', () => {
            render(<Table data={paginatedData} columns={columns} pageSize={10} currentPage={2} totalItems={25} />);
