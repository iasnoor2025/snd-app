...
const Modal = forwardRef<HTMLDivElement, ModalProps>(
    (
        ...
        return (
            <Dialog open={isOpen} onOpenChange={closeOnOutsideClick ? onClose : undefined} modal={showBackdrop}>
                <DialogContent
                    ref={ref}
                    className={cn(
                        'sm:rounded-lg',
                ...
                >
                    {(title || description || showCloseButton) && (
                        <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            {showCloseButton && (
                                <Button variant="ghost" size="icon" className="h-6 w-6" onClick={onClose} aria-label="Close dialog">
                                    <X className="h-4 w-4" />
                    ...
                    <div
                        className={cn(!title && !description && 'pt-6', 'focus:outline-none')}
                        role="dialog"
