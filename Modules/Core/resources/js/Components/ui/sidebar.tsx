...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  ...
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex max-w-full min-h-svh flex-1 flex-col transition-[margin-left] duration-200 ease-linear",
        "ml-[var(--sidebar-width)] peer-data-[state=collapsed]:ml-0",
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "z-50 border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={cn("z-50 group/menu-sub-item relative", className)}
      {...props}
    />
  )
}
