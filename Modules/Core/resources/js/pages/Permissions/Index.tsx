...
import { Edit, Eye, Key, Plus, Search, Trash2 } from 'lucide-react';
...
export default function Index({ auth, permissions }: Props) {
    ...
    const filteredPermissions = permissions.filter(
        (permission) =>
            permission.name.toLowerCase().includes(search.toLowerCase()) || permission.display_name?.toLowerCase().includes(search.toLowerCase()),
    );
    ...
    return (
        <AppLayout title="Permissions Management" breadcrumbs={breadcrumbs} requiredPermission="permissions.view">
