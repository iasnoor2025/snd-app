...
export class ToastService {
    ...
    public static custom(message: string | React.ReactNode, options?: ToastOptions & { type?: ToastType }): string | number {
    ...
    public static update(toastId: string | number, message: string, options?: ToastOptions): void {
