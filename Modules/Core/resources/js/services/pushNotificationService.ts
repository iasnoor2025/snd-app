...
class PushNotificationService {
    ...
    private async removeSubscriptionFromServer(subscription: PushSubscription): Promise<void> {
        try {
            ...
            // Queue for offline sync
            if (navigator.onLine === false) {
                await offlineStorage.queueAction('push_unsubscribe', 'POST', '/api/push/unsubscribe', { subscription }, { priority: 'medium' });
            }
...
export type { NotificationAction, NotificationPayload, NotificationStats, PushSubscription };
