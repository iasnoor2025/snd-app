import { Button, DatePicker, Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Textarea } from '@/Core';
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                ...
                <Input id="name" type="text" value={data.name} onChange={(e) => setData('name', e.target.value)} error={errors.name} required />
            </div>
            ...
            <div>
                ...
                <DatePicker value={data.purchase_date} onChange={(date) => setData('purchase_date', date)} />
            ...
            <div>
                ...
                <DatePicker value={data.last_maintenance_date} onChange={(date) => setData('last_maintenance_date', date)} />
                {errors.last_maintenance_date && <p className="text-sm text-red-600">{errors.last_maintenance_date}</p>}
            </div>

            <div>
                <Label htmlFor="notes">{t('notes')}</Label>
                <Textarea id="notes" value={data.notes} onChange={(e) => setData('notes', e.target.value)} error={errors.notes} />
            </div>
