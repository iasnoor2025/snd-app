...
const FleetOptimization: React.FC<Props> = ({ fleet = [], metrics, scenarios = [], insights = [] }) => {
    ...
    const mockFleet: FleetEquipment[] = [
        {
            ...
            status: 'active',
            location: { lat: 40.7128, lng: -74.006, address: 'Site A, New York' },
            utilization: 85,
            efficiency: 92,
            ...
            alerts: [{ id: '1', type: 'warning', message: 'Hydraulic pressure slightly low', timestamp: '2024-01-10T10:30:00Z' }],
            metrics: {
                hoursOperated: 1250,
                fuelUsed: 18500,
        ...
        },
        {
            ...
            alerts: [{ id: '2', type: 'critical', message: 'Scheduled maintenance overdue', timestamp: '2024-01-08T14:20:00Z' }],
            metrics: {
                hoursOperated: 890,
                fuelUsed: 20300,
        ...
        },
        {
            ...
            alerts: [{ id: '3', type: 'info', message: 'Undergoing scheduled maintenance', timestamp: '2024-01-05T09:00:00Z' }],
            metrics: {
                hoursOperated: 1580,
                fuelUsed: 24500,
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card>
                        <CardContent className="p-4">
                            ...
                            <div className="mt-2 text-sm text-muted-foreground">{mockFleet.filter((e) => e.status === 'active').length} active</div>
                        </CardContent>
                    </Card>
                                    ...
                                    <ResponsiveContainer width="100%" height={250}>
                                        <ComposedChart data={performanceData}>
                                            ...
                                            <Area
                                                ...
                                                stroke="#3b82f6"
                                            />
                                            <Line yAxisId="left" type="monotone" dataKey="efficiency" stroke="#10b981" strokeWidth={2} />
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-2 text-xs">
                                                <div>
                                                    ...
                                                    <div className="truncate font-medium">{equipment.location.address}</div>
                                                </div>
                                                <div>
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <div className="space-y-4">
                                                ...
                                                {/* Impact Metrics */}
                                                <div>
                                                    <h4 className="mb-3 font-medium">Expected Impact</h4>
                                                ...
                                                <div>
                                                    <h4 className="mb-3 font-medium">Implementation</h4>
                                                    <div className="space-y-3">
                                                        <div className="flex justify-between">
                                                            <span className="text-sm">Effort Level:</span>
                                                            <Badge
                                                                variant={
                                                                    selectedScenario.implementation.effort === 'high'
                                                                        ? 'destructive'
                                                                        : selectedScenario.implementation.effort === 'medium'
                                                                          ? 'default'
                                                                          : 'secondary'
                                                                }
                                                            >
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {insight.estimatedValue && (
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-lg font-bold text-green-600">{formatCurrency(insight.estimatedValue)}</span>
                                                </div>
                                            )}
