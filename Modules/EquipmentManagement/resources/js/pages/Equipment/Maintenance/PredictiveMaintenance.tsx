...
const PredictiveMaintenance: React.FC<Props> = ({ equipment = [], predictions = [], recommendations = [] }) => {
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <Button onClick={runPredictiveAnalysis} disabled={isAnalyzing} className="flex items-center gap-2">
                            {isAnalyzing ? <RefreshCw className="h-4 w-4 animate-spin" /> : <Cpu className="h-4 w-4" />}
                                                ...
                                                predictions.map((prediction, index) => (
                                                    <div key={index} className="rounded-lg border p-4">
                                                        <div className="mb-2 flex items-start justify-between">
                                                            ...
                                                            <Badge className={getPriorityColor(prediction.priority)}>{prediction.priority}</Badge>
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            <p className="text-sm">
                                                                <strong>Predicted Failure:</strong> {prediction.predictedFailureDate}
                                                            </p>
                                                            <p className="text-sm">
                                                                <strong>Recommended Action:</strong> {prediction.recommendedAction}
                                                            </p>
                                                            <p className="text-sm">
                                                                <strong>Cost Impact:</strong> {formatCurrency(prediction.costImpact)}
                                                            </p>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            {selectedEquipment && (
                                                <>
                                                    {/* Health Score Chart */}
                                                    <div>
                                                        <h4 className="mb-4 text-lg font-medium">Component Health Scores</h4>
                                                    ...
                                                    {/* Health Metrics */}
                                                    <div>
                                                        <h4 className="mb-4 text-lg font-medium">Detailed Health Metrics</h4>
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                <h4 className="mb-4 text-lg font-medium">Maintenance Activities Trend</h4>
                                                <ResponsiveContainer width="100%" height={300}>
                                            ...
                                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                                <div>
                                                    <h4 className="mb-4 text-lg font-medium">Failure Risk Distribution</h4>
                                                ...
                                                <div>
                                                    <h4 className="mb-4 text-lg font-medium">Cost Analysis</h4>
                                                    <ResponsiveContainer width="100%" height={250}>
                                    ...
                                    {recommendations.length === 0 ? (
                                        ...
                                        recommendations.map((rec) => (
                                            <div key={rec.id} className="rounded-lg border p-3">
                                                <div className="mb-2 flex items-start justify-between">
                                                    <Badge className={getPriorityColor(rec.urgency)}>{rec.urgency}</Badge>
                                                    <span className="text-xs text-muted-foreground">{rec.type}</span>
                                                </div>

                                                <p className="mb-2 text-sm font-medium">{rec.description}</p>
                                                ...
                                                <div className="space-y-1 text-xs text-muted-foreground">
                                                    ...
                                                    {rec.scheduledDate && <div>Scheduled: {rec.scheduledDate}</div>}
                                                </div>

                                                <Button size="sm" className="mt-3 w-full" onClick={() => scheduleMaintenanceTask(rec.id)}>
