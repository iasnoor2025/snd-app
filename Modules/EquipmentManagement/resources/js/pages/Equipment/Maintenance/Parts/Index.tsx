import { AppLayout, Badge, Button, Card, CardContent, CardHeader, CardTitle } from '@/Core';
import { Head } from '@inertiajs/react';
import { format, parseISO } from 'date-fns';
import { Calendar, TruckIcon, User, WrenchIcon } from 'lucide-react';
            ...
            <div className="container mx-auto py-6">
                ...
                <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                    <Card>
                        ...
                        <CardContent>
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Model: {maintenanceRecord.equipment.model}</p>
                                <p className="text-sm text-muted-foreground">SN: {maintenanceRecord.equipment.serial_number}</p>
                            </div>
                            <div className="mt-2">
                                <Button variant="outline" size="sm" asChild>
                                    <a href={route('equipment.show', maintenanceRecord.equipment.id)}>View Equipment</a>
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <div className="mt-2">
                                <Button variant="outline" size="sm" asChild>
                                    <a href={route('equipment.maintenance.schedule.edit', maintenanceRecord.id)}>Reschedule</a>
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent>
                            {maintenanceRecord.performedBy ? (
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">{maintenanceRecord.performedBy.email}</p>
                                </div>
                            ) : (
                ...
                <div className="mt-6 flex justify-end space-x-2">
                    <Button variant="outline" asChild>
                        <a href={route('equipment.maintenance.show', maintenanceRecord.id)}>Back to Maintenance Details</a>
                    </Button>
