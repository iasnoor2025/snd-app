...
import { BreadcrumbItem, PageProps } from '@/Modules/EquipmentManagement/resources/js/types';
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Avg: {formatCurrency(costs.average_cost)} per record</p>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Avg: {Math.round(performance.average_downtime_hours)} hrs per record</p>
                        </CardContent>
                    </Card>
                </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div>
                                        <h3 className="mb-2 text-lg font-semibold">Cost Summary</h3>
                                    ...
                                    <div>
                                        <h3 className="mb-2 text-lg font-semibold">Cost by Type</h3>
                                        <div className="space-y-2">
                                            {Object.entries(costs.cost_by_type).map(([type, data]) => (
                                                <div key={type} className="flex justify-between">
                                                    <span>
                                                        {type.charAt(0).toUpperCase() + type.slice(1)} ({data.count}):
                                                    </span>
                    ...
                    <TabsContent value="performance" className="space-y-4">
                        <Card>
                            ...
                            <CardContent>
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div>
                                        <h3 className="mb-2 text-lg font-semibold">Maintenance Statistics</h3>
                                        <div className="space-y-2">
                                            <div className="flex justify-between">
                                    ...
                                    <div>
                                        <h3 className="mb-2 text-lg font-semibold">Maintenance Schedule</h3>
                                        <div className="space-y-2">
