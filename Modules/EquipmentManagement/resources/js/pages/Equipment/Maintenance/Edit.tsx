...
export default function MaintenanceEdit({ equipment, maintenance }: Props) {
    ...
    const [selectedDate, setSelectedDate] = useState<Date | undefined>(maintenance.scheduled_date ? new Date(maintenance.scheduled_date) : undefined);
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-2">
                                <Button variant="outline" type="button" asChild>
                                    <Link href={route('equipment.maintenance.show', [equipment.id, maintenance.id])}>Cancel</Link>
                                </Button>
                                <Button
                                    type="submit"
