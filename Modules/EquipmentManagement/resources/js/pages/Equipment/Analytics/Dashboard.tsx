                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">{analytics.activeEquipment} active</p>
                        </CardContent>
                    </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div className="text-center">
                                        <div className="text-2xl font-bold text-green-600">{formatCurrency(analytics.revenueGenerated)}</div>
                                        <p className="text-sm text-muted-foreground">Revenue Generated</p>
                                    </div>
                                    <div className="text-center">
                                        <div className="text-2xl font-bold text-red-600">{formatCurrency(analytics.maintenanceCosts)}</div>
                                ...
                                <div className="space-y-4">
                                    {analytics.predictiveInsights.map((insight, index) => (
                                        <div key={index} className="rounded-lg border p-4">
                                            ...
                                            <p className="mb-2 text-sm">{insight.prediction}</p>
                                            <div className="text-sm font-medium text-blue-600">Recommended: {insight.recommendedAction}</div>
                                        </div>
                                    ))}
                                </div>
                            </CardContent>
