        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            {Object.keys(serverErrors).length > 0 && (
                <Alert variant="destructive">
                    <AlertDescription>Please correct the errors below and try again.</AlertDescription>
                </Alert>
            )}
                    ...
                    render={({ field }: { field: any }) => (
                        <FormItem>
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button type="button" variant="outline" size="icon" onClick={() => setIsCreatingLocation(true)}>
                                    <Plus className="h-4 w-4" />
                                </Button>
                            </div>
                            <FormMessage />
            ...
            <FormField
                ...
                render={({ field }: { field: any }) => (
                    <FormItem>
                        ...
                        <div className="text-sm text-muted-foreground">Some description here</div>
                        <FormMessage />
                    </FormItem>
                )}
            />
            ...
            <FormField
                ...
                render={({ field }: { field: any }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input {...field} value={field.value || ''} placeholder="e.g., hours, days, pieces" />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
                ...
                render={({ field }: { field: any }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                            ...
                            <FormDescription>Equipment is available for rental and operations</FormDescription>
                        </div>
                        <FormControl>
            ...
            <div className="flex justify-end gap-2">
                <Button variant="outline" onClick={() => (window.location.href = window.route('equipment.index'))} type="button">
                    Cancel
                </Button>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Add new equipment to your inventory</CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            <Dialog open={isCreatingLocation} onOpenChange={setIsCreatingLocation}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Create a new equipment location</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-2">
                        <div className="space-y-2">
