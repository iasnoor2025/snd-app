...
const CostAnalysis: React.FC<Props> = ({ equipmentCosts = [], costBreakdown = [], optimizations = [], budgetAnalysis }) => {
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        <CardContent className="p-4">
                            ...
                            <div className="mt-2 flex items-center text-sm">
                                <Percent className="mr-1 h-3 w-3 text-green-500" />
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-6">
                                    <div className="rounded border p-4 text-center">
                                        ...
                                        <div className="mt-1 text-xs text-green-500">-2.8%</div>
                                    </div>
                                    <div className="rounded border p-4 text-center">
                                        ...
                                        <div className="mt-1 text-xs text-green-500">-5.2%</div>
                                    </div>
                                    <div className="rounded border p-4 text-center">
                                        <div className="text-2xl font-bold text-orange-600">76%</div>
                                        <div className="text-sm text-muted-foreground">Utilization Rate</div>
                                        <div className="mt-1 text-xs text-green-500">+3.1%</div>
                                    </div>
                                    <div className="rounded border p-4 text-center">
                                        <div className="text-2xl font-bold text-purple-600">15.5%</div>
                                        <div className="text-sm text-muted-foreground">Average ROI</div>
                                        <div className="mt-1 text-xs text-green-500">+1.8%</div>
                                    </div>
                                    <div className="rounded border p-4 text-center">
                                        ...
                                        <div className="mt-1 text-xs text-green-500">-0.3</div>
                                    </div>
                                    <div className="rounded border p-4 text-center">
                                        <div className="text-2xl font-bold text-teal-600">87%</div>
                                        <div className="text-sm text-muted-foreground">Efficiency Score</div>
                                        <div className="mt-1 text-xs text-green-500">+4.2%</div>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                        ...
                                        {/* Monthly Trend */}
                                        <div>
                                            <h4 className="mb-4 font-medium">Monthly Cost Trend</h4>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        {mockOptimizations.map((optimization) => (
                                            <div key={optimization.id} className="rounded border p-4 transition-shadow hover:shadow-md">
                                                ...
                                                <p className="mb-3 text-sm text-muted-foreground">{optimization.description}</p>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-6">
                                        ...
                                        <div className="rounded border bg-green-50 p-6 text-center">
                                            <div className="mb-2 text-3xl font-bold text-green-600">{formatCurrency(totalSavings)}</div>
                                        ...
                                        {/* Savings by Category */}
                                        <div>
                                            <h4 className="mb-3 font-medium">Savings by Category</h4>
                                            <ResponsiveContainer width="100%" height={200}>
                                                <BarChart
                                                    data={mockOptimizations.map((opt) => ({
                                        ...
                                        <div>
                                            <h4 className="mb-3 font-medium">Implementation Priority</h4>
                                            <div className="space-y-2">
                                                {mockOptimizations
                                                    ...
                                                    .map((opt, index) => (
                                                        <div key={opt.id} className="flex items-center justify-between rounded border p-2">
                                                            ...
                                                            <div className="text-sm font-medium text-green-600">{formatCurrency(opt.savings)}</div>
                                                        </div>
                                                    ))}
                                            </div>
                                        </div>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    {mockBudgetAnalysis.categories.map((category) => (
                                        <div key={category.name} className="flex items-center justify-between rounded border p-3">
