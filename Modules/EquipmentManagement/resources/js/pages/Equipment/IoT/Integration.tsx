...
const IoTIntegration: React.FC<Props> = ({ devices = [], equipment = [] }) => {
    ...
    const sendCommand = async () => {
        ...
        setTimeout(() => {
            setCommands((prev) => prev.map((cmd) => (cmd.id === command.id ? { ...cmd, status: 'sent' } : cmd)));
        }, 1000);
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">
                                        {devices.reduce((acc, d) => acc + d.sensors.filter((s) => getSensorStatus(s) !== 'normal').length, 0)}
                                    </p>
                                </div>
                            ...
                            {devices.map((device) => (
                                ...
                                >
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            <span>Signal:</span>
                                            <span className={getSignalStrengthColor(device.signalStrength)}>{device.signalStrength}%</span>
                                        </div>
                                        {device.batteryLevel && (
                                            <div className="flex justify-between">
                                                <span>Battery:</span>
                                            ...
                                            <div className="space-y-6">
                                                ...
                                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                                                    {selectedDevice.sensors.map((sensor) => {
                                                        ...
                                                        return (
                                                            <div key={sensor.id} className="rounded-lg border p-4">
                                                                <div className="mb-2 flex items-center justify-between">
                                                                    <div className="flex items-center gap-2">
                                                ...
                                                <div className="space-y-4">
                                                    {selectedDevice.sensors.slice(0, 2).map((sensor) => {
                                                        ...
                                                        return (
                                                            <div key={sensor.id}>
                                                                <h4 className="mb-2 text-sm font-medium">{sensor.name} Trend</h4>
                                        ...
                                        <CardContent>
                                            <div className="space-y-6">
                                                ...
                                                <div className="rounded-lg border p-4">
                                                    <h4 className="mb-4 font-medium">Send Command</h4>
                                                    <div className="space-y-4">
                                                        <div>
                                                ...
                                                {/* Command History */}
                                                <div className="rounded-lg border p-4">
                                                    <h4 className="mb-4 font-medium">Command History</h4>
                                        ...
                                        <CardContent>
                                            <div className="space-y-6">
                                                ...
                                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                    <div className="rounded-lg border p-4">
                                                        <h4 className="mb-3 font-medium">Connectivity</h4>
                                                    ...
                                                    <div className="rounded-lg border p-4">
                                                        <h4 className="mb-3 font-medium">System Info</h4>
                                                        <div className="space-y-2 text-sm">
                                                            <div className="flex justify-between">
                                                                <span>Device ID:</span>
                                                ...
                                                <div className="rounded-lg border p-4">
                                                    ...
                                                    <div className="space-y-2 text-sm">
                                                        <div>
                                                            <strong>Address:</strong> {selectedDevice.location.address}
                                                        </div>
                                                        <div>
                                                            <strong>Coordinates:</strong> {selectedDevice.location.lat.toFixed(6)},{' '}
                                                ...
                                                {/* Sensor Status */}
                                                <div className="rounded-lg border p-4">
                                                    <h4 className="mb-3 font-medium">Sensor Status</h4>
                                            ...
                                            selectedDevice.sensors
                                                ...
                                                .map((sensor) => {
                                                    ...
                                                    return (
                                                        <Alert
                                                            key={sensor.id}
                                                            className={status === 'critical' ? 'border-red-200' : 'border-yellow-200'}
                                                        >
                                                            <AlertTriangle className="h-4 w-4" />
