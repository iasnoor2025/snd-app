...
import { Activity, AlertTriangle, Bell, CheckCircle, Pause, Play, Settings } from 'lucide-react';
                            ...
                            {equipment.map((eq) => (
                                ...
                                >
                                    <div className="mb-2 flex items-center justify-between">
                                        ...
                                        <div className={`h-3 w-3 rounded-full ${getStatusColor(eq.status)}`} />
                                    </div>
                                    ...
                                    <CardContent>
                                        <Tabs defaultValue="performance" className="space-y-4">
                                                ...
                                                {performanceData && (
                                                    <div className="space-y-4">
                                                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                            <div>
                                                                <h4 className="mb-2 text-sm font-medium">Fuel Consumption</h4>
                                            ...
                                            <TabsContent value="diagnostics">
                                                {performanceData && (
                                                    <div className="space-y-4">
                                                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                            <div>
                                                                <h4 className="mb-2 text-sm font-medium">Vibration Levels</h4>
                                                                <ResponsiveContainer width="100%" height={200}>
                                            ...
                                            <TabsContent value="efficiency">
                                                {performanceData && (
                                                    <div>
                                                        <h4 className="mb-2 text-sm font-medium">Efficiency Trend</h4>
