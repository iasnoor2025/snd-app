...
const LifecycleManagement: React.FC<Props> = ({ equipment, lifecycleStages = [], lifecycleEvents = [], analytics }) => {
    ...
    const filteredEvents = eventFilter === 'all' ? mockEvents : mockEvents.filter((event) => event.type === eventFilter);
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">
                                        {equipment.currentAge}/{equipment.expectedLifespan}y
                                    </p>
                                </div>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className={`text-2xl font-bold capitalize ${getConditionColor(equipment.condition)}`}>{equipment.condition}</p>
                                </div>
                                <Shield className="h-8 w-8 text-purple-600" />
                            </div>
                            <div className="mt-2 text-sm text-muted-foreground">Last inspection: {equipment.lastInspection || 'N/A'}</div>
                        </CardContent>
                    </Card>
                </div>
                                    ...
                                    {mockStages.map((stage, index) => (
                                        <div key={stage.id} className="flex items-start gap-4">
                                            <div className="flex flex-col items-center">
                                                ...
                                                {index < mockStages.length - 1 && <div className="mt-2 h-16 w-px bg-gray-200" />}
                                            </div>
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <div className="mt-2 flex items-center gap-4 text-sm">
                                                    ...
                                                    {stage.endDate && <span>End: {new Date(stage.endDate)}</span>}
                                                    <span>Cost: {formatCurrency(stage.cost)}</span>
                                                    {stage.duration && <span>Duration: {stage.duration} days</span>}
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                                    ...
                                    <div className="space-y-2">
                                        {mockStages.map((stage) => (
                                            ...
                                            >
                                                ...
                                                <p className="mt-1 text-sm text-muted-foreground">{stage.description}</p>
                                                <div className="mt-2 text-xs text-muted-foreground">Cost: {formatCurrency(stage.cost)}</div>
                                            </div>
                                        ))}
                                    </div>
                                </CardContent>
                                ...
                                <div className="space-y-4 lg:col-span-2">
                                    <Card>
                                        ...
                                        <CardContent>
                                            ...
                                            <div className="mb-6">
                                                ...
                                                <div className="space-y-2">
                                                    {selectedStage.milestones.map((milestone) => (
                                                        <div key={milestone.id} className="flex items-center gap-3 rounded border p-2">
                                                            {milestone.completed ? (
                                                            ...
                                                            <div className="flex-1">
                                                                <span
                                                                    className={`text-sm ${milestone.completed ? 'text-muted-foreground line-through' : ''}`}
                                                                >
                                                                    {milestone.name}
                                                                </span>
                                                                <div className="text-xs text-muted-foreground">{new Date(milestone.date)}</div>
                                                            </div>
                                                        </div>
                                                    ))}
                                                </div>
                                            ...
                                            {/* KPIs */}
                                            <div className="mb-6">
                                                <h4 className="mb-3 font-medium">Key Performance Indicators</h4>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    {filteredEvents.map((event, index) => (
                                        <div key={event.id} className="flex items-start gap-4 rounded border p-4 hover:bg-gray-50">
                                            <div className="flex flex-col items-center">
                                                <div className="rounded-full bg-blue-100 p-2 text-blue-600">{getEventIcon(event.type)}</div>
                                                {index < filteredEvents.length - 1 && <div className="mt-2 h-16 w-px bg-gray-200" />}
                                            </div>
                                            <div className="min-w-0 flex-1">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-sm text-muted-foreground">{new Date(event.date)}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-2 flex items-center gap-4 text-sm">
                                                    ...
                                                    {event.cost && <span>Cost: {formatCurrency(event.cost)}</span>}
                                                </div>
                                            </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    ...
                                    <div className="text-center">
                                        <div className="text-2xl font-bold text-green-600">
                                            {formatCurrency(analytics.benchmarks.industryAverage)}
                                        </div>
